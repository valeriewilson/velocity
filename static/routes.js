function displayFilteredRoutes(results) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        $('#all-routes').append("<div class='saved-routes' class='container col-xs-3'></div><div class='row container col-xs-4'><p>" + miles.toFixed(1) + " miles | " + Math.round(minutes) + " minutes | " + Math.round(elevation) + " ft | " + addendum + "</p></div>");

        $('#all-routes').append("<div class='saved-routes' class='container col-xs-3'></div><div class='map' id='map" + route_id + "' data-id='" + route_id + "' class='row container col-xs-4'></div>");
    }
